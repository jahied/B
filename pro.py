...
def Subscraption():
	...
	clear()
	print(logo)
	r1=requests.get("https://github.com/noobboss1/main/blob/main/x/c/h/error/file1.txt").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		Main()
		...
		print(logo)
		print ("")
		print(" \033[1;32m KAUSAR Tool Paid You Need Get Approved First\033[1;37m\n")
		print ("")
